...
class TqSdkDemo(object):
    def __init__(self):
        # self.account = TqAccount("快期模拟", "ysyc2005@126.com", "Good.day$2020")
        # self.account = TqAccount("S首创期货", "10600360", "687913")
        # self.api = TqApi(self.account)
        # self.api = TqApi(TqSim())
        self.api = TqApi(TqSim(), TqAuth("13286016839", "Good.day$2020"))   # sdk 2.0.4
